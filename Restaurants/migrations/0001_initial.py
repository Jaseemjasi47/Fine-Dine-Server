# Generated by Django 4.2.3 on 2023-07-23 12:56
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True, null=True, upload_to='resimages/')),
                ('description', models.TextField()),
                ('license', models.FileField(blank=True, null=True, upload_to='licenses/')),
                ('status', models.CharField(choices=[('Pending', 'Pending'), ('Approved', 'Approved'), ('Rejected', 'Rejected')], default='Pending', max_length=20)),
                ('created_date', models.DateTimeField(auto_now_add=True)),
                ('ratings', models.DecimalField(decimal_places=1, default=0, max_digits=3)),
